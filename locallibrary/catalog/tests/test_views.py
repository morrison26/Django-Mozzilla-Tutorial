...
class AuthrListViewTest(TestCase):
    @classmethod
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        test_user2 = User.objects.create_user(username = "testuser2", password = "456")
    ...
    def test_redirect_if_logged_in_not_correct_permission(self):
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        login = self.client.login(username='testuser2', password = "456")
        response = self.client.get(reverse('renew-book-librarian', kwargs={'pk': self.test_bookinstance2.pk}))
